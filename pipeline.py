...
N_FEATS_P1      = 77 + N_FFT_FEATS + N_TDA_FEATS + N_MP_FEATS + N_ROLL_NEW + N_FFT_BROAD + N_CUSUM_FEATS  # 110
N_FEATS_P2      = 84 + N_FFT_FEATS + N_TDA_FEATS + N_MP_FEATS + N_ROLL_NEW + N_FFT_BROAD + N_CUSUM_FEATS  # 117
PSEUDO_WEIGHT   = 0.70
...
def make_features(x, timestamps, train_x_ref, info, service, top_services,
    ...
    """110-feature P1 = 77 base + 5 FFT + 10 TDA + 6 MP + 6 roll + 4 FFT-broad + 2 CUSUM."""
...
def run_validation(pseudo_labels,wid_map):
    ...
    print_summary_v2(rep,"v67 more-MP+CUSUM (CW-LOO)")
    return rep


def generate_submission(ensembles,top_services,test_gs,
                        output=Path("submission_v67_more_mp_cusum.json")):
...
if __name__ == "__main__":
    ...
    print("\nDone. Submit submission_v67_more_mp_cusum.json")
